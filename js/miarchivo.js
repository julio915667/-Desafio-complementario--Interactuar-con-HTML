...
title.innerHTML = computer[0].name + "<br>" + computer[0].price
let title2 = document.getElementById("titleHead2")
title2.innerHTML = computer[1].name + "<br>" + computer[1].price

function caracteristics(index, visualization) {
     let contenedor = document.createElement("ul");
     contenedor.innerHTML = `<li> ${product[index].mother} </li>
